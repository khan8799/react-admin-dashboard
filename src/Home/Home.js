...
import AppSummary from '../shared/components/appsummary/AppSummary'
        ...
        <>
            <div className="main-panel">
                <div className="content-wrapper">
                    ...
                    <Breadcrumbs name='Dashboard' rightMenu={[1]} />

                    <div className="row">

                        {appsummary.map((summaryreport, i) => <AppSummary key={i} summaryreport={summaryreport} />)}
