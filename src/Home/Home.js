// import SummaryCart from '../SummaryData/SummaryCart'
import SummaryTable from '../SummaryData/SummaryData'
import Footer from './../shared/components/Footer/Footer'
import { Outlet } from 'react-router-dom'
import SummaryHeader from './../SummaryData/SummaryHeader'
                                ...
                                <div className="card-body">
                                    ...
                                    {<div className="row mt-3">
                                        <div className="col-6 pe-1">
                                            <img alt="" src="assets/images/dashboard/img_1.jpg" className="mb-2 mw-100 w-100 rounded" alt="image" />
                                            <img alt="" src="assets/images/dashboard/img_4.jpg" className="mw-100 w-100 rounded" alt="image" />
                                        </div>
                                        <div className="col-6 ps-1">
                                            <img alt="" src="assets/images/dashboard/img_2.jpg" className="mb-2 mw-100 w-100 rounded" alt="image" />
                                            <img alt="" src="assets/images/dashboard/img_3.jpg" className="mw-100 w-100 rounded" alt="image" />
                                        </div>
                                    </div> }
                                    {<div className="d-flex mt-5 align-items-top">
                                        <img alt="" src="assets/images/faces/face3.jpg" className="img-sm rounded-circle me-3" alt="image" />
